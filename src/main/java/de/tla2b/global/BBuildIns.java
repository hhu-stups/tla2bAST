...
public interface BBuildIns {
	...
	UniqueString OP_string = UniqueString.uniqueStringOf("STRING");

	// Sets
	UniqueString OP_card = UniqueString.uniqueStringOf("Cardinality");
	UniqueString OP_finite = UniqueString.uniqueStringOf("IsFiniteSet");

	// Sequences
	UniqueString OP_len = UniqueString.uniqueStringOf("Len");
	UniqueString OP_append = UniqueString.uniqueStringOf("Append");
	UniqueString OP_seq = UniqueString.uniqueStringOf("Seq");
	UniqueString OP_head = UniqueString.uniqueStringOf("Head");
	UniqueString OP_tail = UniqueString.uniqueStringOf("Tail");
	UniqueString OP_subseq = UniqueString.uniqueStringOf("SubSeq");
	UniqueString OP_conc = UniqueString.uniqueStringOf("\\o");

	//TLA2B
	UniqueString OP_min = UniqueString.uniqueStringOf("MinOfSet");
	UniqueString OP_max = UniqueString.uniqueStringOf("MaxOfSet");
	UniqueString OP_setprod = UniqueString.uniqueStringOf("SetProduct");
	UniqueString OP_setsum = UniqueString.uniqueStringOf("SetSummation");
	UniqueString OP_permseq = UniqueString.uniqueStringOf("PermutedSequences");

	//BBuildIns
	UniqueString OP_pow1 = UniqueString.uniqueStringOf("POW1");

	//Relations
	UniqueString OP_rel_inverse = UniqueString.uniqueStringOf("rel_inverse");

	//TLC
	UniqueString OP_assert = UniqueString.uniqueStringOf("Assert");
